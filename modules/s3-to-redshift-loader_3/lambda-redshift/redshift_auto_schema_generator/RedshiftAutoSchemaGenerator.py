...
class RedshiftAutoSchemaGenerator():
    ...
    Attributes:
        ...
        sort_key (str, optional): Name of columns that should be the sort key (separated by commas), defaults to AUTO.
        ...
        column_name_sanitizers (Tuple[(str, str)]): Optional list of tuples to replace special characters
